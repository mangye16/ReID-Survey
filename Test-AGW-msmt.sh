...
DATASETS.NAMES "('msmt17')" DATASETS.ROOT_DIR  "('./toDataset')" MODEL.PRETRAIN_CHOICE "('self')" \
TEST.WEIGHT "('./pretrained/msmt17_AGW.pth')" TEST.EVALUATE_ONLY "('on')" OUTPUT_DIR "('./log/Test')"
