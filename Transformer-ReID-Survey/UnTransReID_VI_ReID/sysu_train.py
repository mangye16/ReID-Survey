...
from clustercontrast.trainers_s123 import ClusterContrastTrainer_pretrain_camera_confusionrefine_noice# as ClusterContrastTrainer_pretrain_joint
...
# def main_worker(args,cfg):
    ...
    trainer.cmlabel=10000#30#30#1000
    s2_cmav1 =30#30
