...
class build_transformer(nn.Module):
    def __init__(self, num_classes, camera_num, view_num, cfg, factory):
        ...
        self.base.patch_embed_lptn = copy.deepcopy(self.base.patch_embed)
    ...
    def forward(self, x1, x2, modal=0,label_1=None,label_2=None):#(self, x, label=None, cam_label= None, view_label=None):
        ...
        feat,feat1,feat2,label_1,label_2 = self.base(x1,x2,modal=modal,label_1=label_1,label_2=label_2)
        # if self.reduce_feat_dim:
        #     global_feat = self.fcneck(global_feat)
        ...
        if self.training:
            ...
            return feat,feat[:single_size],feat[single_size:],label_1,label_2  # global feature for triplet loss
        else:
            # if self.neck_feat == 'after':
