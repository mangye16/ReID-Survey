...
class build_transformer(nn.Module):
    ...
    def forward(self, x1, x2, modal=0,label_1=None,label_2=None,cid_rgb=None,cid_ir=None,index_rgb=None,index_ir=None):#(self, x, label=None, cam_label= None, view_label=None):
        single_size = x1.size(0)
        feat,feat1,feat2,gf1,gf2,label_1,label_2,cid_rgb,cid_ir,index_rgb,index_ir = self.base(x1,x2,modal=modal,label_1=label_1,label_2=label_2,cid_rgb=cid_rgb,cid_ir=cid_ir,index_rgb=index_rgb,index_ir=index_ir)
        # if self.reduce_feat_dim:
        #     global_feat = self.fcneck(global_feat)
        ...
        if self.training:
            ...
            return feat,feat[:single_size],feat[single_size:],gf1,gf2,label_1,label_2,cid_rgb,cid_ir,index_rgb,index_ir  # global feature for triplet loss
        else:
            # if self.neck_feat == 'after':
