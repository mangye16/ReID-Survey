...
DATASETS.NAMES "('cuhk03')" DATASETS.ROOT_DIR  "('./toDataset')" MODEL.PRETRAIN_CHOICE "('self')" \
TEST.WEIGHT "('./pretrained/cuhk03_AGW.pth')" TEST.EVALUATE_ONLY "('on')" OUTPUT_DIR "('./log/Test')"
